...
public class GroupController {
    ...
    public ResponseEntity<?> getAllGroups(@RequestParam(defaultValue = "0") Integer pageNo,
        ...
        Response<PaginationResponse<GroupModel>> response = new Response<>(HttpStatus.OK.value(), true, paginatedData, "Groups fetched successfully.");
    ...
    public ResponseEntity<?> getSpecificGroup(@PathVariable  Long groupId) {
        ...
        Response<GroupModel> response = new Response<>(HttpStatus.OK.value(), true, group, "Group fetched successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> createGroup(@RequestBody GroupRequest groupRequest, Principal connectedUser) {
        ...
        Response<GroupModel> response = new Response<>(HttpStatus.OK.value(), true, group, "Group created successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> updateGroup(@PathVariable Long groupId, @RequestBody GroupRequest groupRequest) {
        ...
        Response<GroupModel> response = new Response<>(HttpStatus.OK.value(), true, group, "Group updated successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteGroup(@PathVariable Long groupId) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Group with ID " + groupId + " deleted successfully.", "Group deleted successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> addContest(@PathVariable Long groupId, @PathVariable Long contestId) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Contest added successfully.", "Contest added successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> inviteUserToGroup(@RequestBody InvitationRequest invitationRequest, Principal connectedUser) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Invitation sent successfully.", "Invitation sent successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> acceptInvitation(@PathVariable Long invitationId, Principal connectedUser) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Invitation accepted successfully.", "Invitation accepted successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> declineInvitation(@PathVariable Long invitationId, Principal connectedUser) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Invitation declined successfully.", "Invitation declined successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> requestJoin(@PathVariable Long groupId, Principal connectedUser) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Request sent successfully.", "Request sent successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> declineRequest(@PathVariable Long requestId) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "Request declined successfully.", "Request declined successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> joinUserGroup(@PathVariable Long groupId, Principal connectedUser) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "User joined successfully.", "User joined successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> leaveUserGroup(@PathVariable Long groupId, Principal connectedUser) {
        ...
        Response<String> response = new Response<>(HttpStatus.OK.value(), true, "User left successfully.", "User left successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getGroupContests(@PathVariable Long groupId) {
        ...
        Response<List<Contest>> response = new Response<>(HttpStatus.OK.value(), true, contests, "Contests fetched successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getGroupUsers(@PathVariable Long groupId) {
        ...
        Response<List<User>> response = new Response<>(HttpStatus.OK.value(), true, users, "Users fetched successfully.");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
